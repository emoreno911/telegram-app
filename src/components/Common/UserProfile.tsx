...
function GameProfileCard({
  ...
  return (
    <div className="z-10 w-96 mx-auto text-white px-0 py-6">
        ...
        <div className="w-full flex flex-col items-center space-y-4">
					...
					<div className="w-full grid grid-cols-3 gap-4 text-center">
						<div className="flex flex-col items-center space-y-2 group">
							<IconTrophy className="w-14 h-14 text-yellow-400 group-hover:animate-bounce" />
							<span className="text-sm text-gray-400">Top Score</span>
							<span className="text-3xl font-semibold">{topScore}</span>
						</div>
						<div className="flex flex-col items-center space-y-2 group">
							<IconStar className="w-14 h-14 text-blue-400 group-hover:animate-spin" />
							<span className="text-sm text-gray-400">Total Points</span>
							<span className="text-3xl font-semibold">{totalPoints}</span>
						</div>
						<div className="flex flex-col items-center space-y-2 group">
							<IconClock className="w-14 h-14 text-green-400 group-hover:animate-pulse" />
